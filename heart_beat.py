...
Patient = "P022" #"P015/P015_S01_D2024-07-06"
run = None
...
x_data_filtered, _, _, _ = analysis.ICA_filter(x_data_intervall, heart_beat_score_threshold=0.80, print_result=True, plot_result=True)
y_data_filtered, _, _, _ = analysis.ICA_filter(y_data_intervall, heart_beat_score_threshold=0.80, print_result=True, plot_result=True)
z_data_filtered, _, _, _ = analysis.ICA_filter(z_data_intervall, heart_beat_score_threshold=0.80, print_result=True, plot_result=True)
